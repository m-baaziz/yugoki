import { SiteSearchQueryInput } from '../generated/graphql';
import utf8 from 'utf8';

export const QUERY_KEY = 'search';
export const DEFAULT_QUERY: SiteSearchQueryInput = {
  sport: '630d3903c8972c1b4d5eb3f6',
  address: '川崎',
};

export function encodeQuery(query: SiteSearchQueryInput): string {
...
export function decodeQuery(query: string): SiteSearchQueryInput {
